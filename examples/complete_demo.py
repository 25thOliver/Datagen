...
def main():
    ...
    profiles_test = generate_profiles(n=20, seed=SEED)
    salaries_test = generate_salaries(n=200, seed=SEED)
    regions_test = generate_regions(seed=SEED)
    cars_test = generate_cars(n=20, seed=SEED)
    
    print(f"  Profiles reproducible: {profiles.head(20).equals(profiles_test)}")
    print(f"  Salaries reproducible: {salaries.head(20).equals(salaries_test)}")
    print(f"  Regions reproducible: {regions.equals(regions_test)}")
    print(f"  Cars reproducible: {cars.head(20).equals(cars_test)}")
    # ------------------------------------------------------------------------
